...
This document describes how we map the checklist data to Darwin Core. The source file for this document can be found [here](https://github.com/trias-project/uredinales-belgium-checklist/blob/master/src/dwc_checklist.Rmd).
