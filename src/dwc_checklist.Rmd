...
This dataframe gives a nice structured overview of all interactions between the host plant and the parasite. We clean it and we save the information in a new dataframe `interactions`, as we will need this to construct the Resource Relationship extension (see xxx):
